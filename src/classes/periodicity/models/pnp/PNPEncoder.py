...
from src.classes.periodicity.models.fourier.FourierBlock import FourierBlock
from src.classes.periodicity.models.orthogonal_poly.OrthogonalPolynomialBlock import \
